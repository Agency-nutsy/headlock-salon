  ...
  return (
    <div className={styles.sliderWrap}>
      ...
      >
        ...
        <img src={after} alt="After transformation at Headlocks" style={{ zIndex: 1 }} />

        {/* Before image (clipped) */}
        <div style={{ position: 'absolute', top: 0, left: 0, width: `${position}%`, height: '100%', overflow: 'hidden', zIndex: 2 }}>
          <img src={before} alt="Before transformation at Headlocks" style={{ width: containerRef.current ? containerRef.current.offsetWidth + 'px' : '100%', maxWidth: 'none', height: '100%', objectFit: 'contain' }} />
        </div>
    ...
    <section className={`section ${styles.section}`}>
      <div className="container">
        <div className="section-header" data-aos="fade-up">
          ...
          <p className="section-subtitle">Drag the slider to see real before & after results from Headlocks.</p>
        </div>
