...
const team = [
  {
    name: 'Our Expert Stylists',
    role: 'Founder & Makeup Artist',
    photo: '/salon/bridal-makeup.png',
    bio: 'Founder of Headlocks, Tanvi is celebrated for her bridal artistry. Clients praise her ability to deliver exactly the look they envision — natural, elegant, and picture-perfect.',
  ...
  },
  {
    ...
    bio: 'David is the go-to stylist at Headlocks, known for precision cuts and subtle, soft hair makeovers. Reviewers consistently highlight his skill and friendly demeanour.',
          ...
          {team.map((member, i) => (
            <div className={styles.card} key={i} data-aos="fade-up" data-aos-delay={i * 150}>
              <div className={styles.imageWrap}>
                <img
                  src={member.photo}
                  alt={`${member.name} — ${member.role} at Headlocks, Delhi`}
                  width={400}
                  height={500}
                  loading="lazy"
                  decoding="async"
              ...
              <div className={styles.cardBody}>
                ...
                <a
                  href={`https://wa.me/919211785275?text=${encodeURIComponent(`Hi! I'd like to book an appointment with ${member.name} (${member.role}) at Headlocks.`)}`}
                  target="_blank"
