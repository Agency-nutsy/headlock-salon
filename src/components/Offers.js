      ...
      <div className="container">
        ...
        <div className={styles.offersGrid}>
          {offers.map((offer, i) => (
            <div className={styles.offerCard} key={i} data-aos="fade-up" data-aos-delay={i * 80}>
              ...
              <a
                href={`https://wa.me/919211785275?text=${encodeURIComponent(`Hi! I'd like to claim the "${offer.title}" offer at Headlocks.`)}`}
                target="_blank"
        ...
        <div className={styles.membershipSection}>
          <div className="section-header" data-aos="fade-up">
            ...
            <h2 className="section-title">Join the <span className="gold-text">Headlocks Club</span></h2>
          </div>
          ...
          <div className={styles.membershipGrid}>
            {memberships.map((m, i) => (
              <div className={`${styles.memberCard} ${i === 1 ? styles.memberCardGold : ''}`} key={i} data-aos="fade-up" data-aos-delay={i * 150}>
                ...
                <a
                  href={`https://wa.me/919211785275?text=${encodeURIComponent(`Hi! I'd like to join the ${m.tier} Membership at Headlocks. Please share more details.`)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="btn-gold"
        ...
        <div className={styles.voucherSection} data-aos="fade-up">
          <div className={styles.voucherCard}>
            ...
            <a
              href="https://wa.me/919211785275?text=Hi!%20I'd%20like%20to%20order%20a%20Gift%20Voucher%20from%20Studio%20Fix."
              target="_blank"
              rel="noopener noreferrer"
