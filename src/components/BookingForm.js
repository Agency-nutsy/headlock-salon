...
export default function BookingForm() {
  ...
  const handleSubmit = (e) => {
    ...
    const waText = `Hello Headlocks! 🙏\n\nI would like to book an appointment.\n\n👤 Name: ${name}\n📞 Phone: ${phone}\n✂️ Service: ${service}\n📅 Date: ${date}\n⏰ Time: ${time}\n📝 Notes: ${message || 'None'}\n\nPlease confirm my booking. Thank you!`;

    setShowConfirmation(true);

    setTimeout(() => {
      const encodedText = encodeURIComponent(waText);
      window.open(`https://wa.me/919211785275?text=${encodedText}`, '_blank');
    ...
    <section className={`section ${styles.booking}`}>
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div className={styles.altContact} data-aos="fade-up">
          <a href="tel:+919211785275" className={styles.altItem}>
            <span>📞</span>
            <div>
              <strong>Call Us</strong>
              <span>092117 85275</span>
            </div>
          </a>
          <a href="https://maps.app.goo.gl/pLdkFuG9oHy7ndHg9" target="_blank" rel="noopener noreferrer" className={styles.altItem}>
            <span>📍</span>
            <div>
              <strong>Visit Us</strong>
              <span>E Block, E-103, near Afghani Dhaba, Block I, Lajpat Nagar II, Lajpat Nagar, New Delhi, Delhi 110024</span>
            </div>
          </a>
        </div>
      </div>
