...
const packages = [
  ...
  },
  {
    ...
    items: [
      ...
      'Bridal Makeup (HD/Airbrush by Our Expert Stylists)',
...
const portfolioImages = [
  { src: '/salon/bridal-makeup.png', caption: 'Bridal Makeup by Our Expert Stylists' },
  ...
  { src: '/salon/reception-desk.jpg', caption: 'Headlocks Unisex Salon' },
];
      ...
      <div className="container" style={{ position: 'relative', zIndex: 2 }}>
        ...
        <div className="section-header" data-aos="fade-up">
          ...
          <p className="section-subtitle">
            From pre-bridal glow treatments to the final bridal look on your big day — Our Expert Stylists and the Headlocks team craft
          ...
          <div className={styles.portfolioGrid}>
            {portfolioImages.map((img, i) => (
              <div className={styles.portfolioItem} key={i}>
                <img
                  src={img.src}
                  alt={`${img.caption} at Headlocks, Delhi`}
                  width={600}
                  height={400}
                  loading="lazy"
                  decoding="async"
        ...
        <div className={styles.grid}>
          {packages.map((pkg, i) => (
            ...
            >
              ...
              <a
                href={`https://wa.me/919211785275?text=${encodeURIComponent(`Hi! I'm interested in the ${pkg.name} bridal package. Please share more details.`)}`}
                target="_blank"
