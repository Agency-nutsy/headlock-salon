...
const services = [
  ...
  { cat: 'Makeup', icon: '👰', name: 'Bridal Makeup', desc: 'Complete bridal look by Our Expert Stylists including draping assistance.', price: 'Price on request', duration: '2–3 hrs' },
        ...
        <div className={styles.grid}>
          {filtered.map((service, i) => (
            ...
            >
              ...
              <a
                href={`https://wa.me/919211785275?text=${encodeURIComponent(`Hi! I'd like to book "${service.name}" at Headlocks.`)}`}
                target="_blank"
