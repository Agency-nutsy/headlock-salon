...
/* ============================================
   Headlocks UNISEX SALON & MAKEUP — by Our Expert Stylists
   ============================================ */
const SALON_NAME = 'Headlocks Unisex Salon';
const SALON_TAGLINE = 'Luxury Hair, Makeup & Beauty Redefined';
const SALON_PHONE = '092117 85275';
const SALON_PHONE_RAW = '+919211785275';
const SALON_DOMAIN = 'https://headlocks-salon.com'; // Keeping as a placeholder or original if preferred, but usually updated
const SALON_ADDRESS = 'E Block, E-103, near Afghani Dhaba, Block I, Lajpat Nagar II, Lajpat Nagar';
const SALON_CITY = 'Delhi';
const SALON_STATE = 'Delhi';
const SALON_PIN = '110024';
const SALON_RATING = '4.7';
const SALON_REVIEW_COUNT = '229';
const SALON_HOURS = 'Mo-Su 10:00-22:00';
const SALON_OWNER = 'Headlocks';
const SALON_INSTAGRAM = 'https://www.instagram.com/headlockslajpatnagar/';
const SALON_GOOGLE_MAPS = 'https://maps.app.goo.gl/pLdkFuG9oHy7ndHg9';
/* ============================================ */

export const metadata = {
  metadataBase: new URL(SALON_DOMAIN),
  title: {
    default: `Headlock Salon`,
    template: `%s | Headlock Salon`,
  },
